...
__all__ = ('GrokModel', 'GrokModelSettings')


class GrokModelSettings(OpenAIChatModelSettings, total=False):
    """Settings for xAI Grok model requests. Inherits all options from OpenAIChatModelSettings."""
