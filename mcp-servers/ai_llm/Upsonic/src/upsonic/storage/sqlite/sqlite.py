...
class SqliteStorage(Storage):
    ...
    def _row_to_dict(row: Any) -> Dict[str, Any]:
        # SQLAlchemy Row -> dict, JSON columns come back as dicts already.
    ...
    def upsert_usage_entry(self, entry: Dict[str, Any]) -> None:
        ...
        # SQLite-flavoured ON CONFLICT DO UPDATE for idempotency.
        stmt = sqlite.insert(table).values(**entry)
        stmt = stmt.on_conflict_do_update(
