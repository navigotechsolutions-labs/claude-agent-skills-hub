...
- [React client API reference](/typescript/api-reference/client/react-client) - Provider props, hook return values, server options, and storage types
- [Authentication](/typescript/client/authentication) - OAuth, bearer tokens, and pre-registered client credentials
- [Building agents](/typescript/agent) - AI agents that call tools from connected MCP servers
- [Environments](/typescript/client/environments) - Node.js, browser, and React client entry points
