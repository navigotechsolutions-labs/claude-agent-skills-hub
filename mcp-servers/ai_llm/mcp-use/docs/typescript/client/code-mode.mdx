...
**VM Executor Example:** See [`examples/agent/code-mode/code_mode_example.ts`](https://github.com/mcp-use/mcp-use/tree/main/libraries/typescript/packages/mcp-use/examples/agent/code-mode/code_mode_example.ts) for a complete working example using the default VM executor with the filesystem MCP server.


**E2B Executor Example:** See [`examples/agent/code-mode/code_mode_e2b_example.ts`](https://github.com/mcp-use/mcp-use/tree/main/libraries/typescript/packages/mcp-use/examples/agent/code-mode/code_mode_e2b_example.ts) for a complete working example using E2B cloud sandboxes.

## Further Reading

- [Code Mode API reference](/typescript/api-reference/client/code-mode) - `MCPClientOptions`, `CodeModeConfig`, executor options, `ExecutionResult`, `ToolSearchResponse`, and `BaseCodeExecutor` signatures
