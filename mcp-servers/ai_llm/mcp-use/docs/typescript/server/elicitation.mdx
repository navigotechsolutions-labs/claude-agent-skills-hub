...
<CardGroup cols={2}>
  ...
  <Card title="Elicitation schemas API reference" icon="list-checks" href="/typescript/api-reference/server/elicitation-schemas">
    Look up enum schema helpers for advanced form schemas.
  </Card>
