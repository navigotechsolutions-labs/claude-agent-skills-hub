...
<CardGroup cols={2}>
  <Card title="MCP Apps Guide" icon="app-window-mac" href="/typescript/mcp-apps">
    Widgets, auto-discovery, props, and client-side hooks.
  </Card>
  <Card title="Creating an MCP Apps Server" icon="circle-play" href="/typescript/mcp-apps/quickstart">
    Step-by-step: scaffold and ship your first widget.
  </Card>
  <Card title="Apps SDK compatibility" icon="message-square" href="/typescript/mcp-apps/apps-sdk-compatibility">
